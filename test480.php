...
<body>
    <div class="container">
        <h1>Pause Log</h1>
        <form method="post" action="<?php echo htmlspecialchars('test479.php'); ?>" id="pauseLogForm">
    ...
    <script>
        function quit() {
            window.location.replace("test204.php?page=<?php echo urlencode($o); ?>&page1=<?php echo urlencode($p); ?>");
        }
