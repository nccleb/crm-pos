...
<head>
    ...
    <title>Agent Details - Search</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <h1>Agent Details</h1>
        <form method="post" action="test475.php" id="searchForm">
            ...
            <div class="form-group">
                <label for="con">Connect Status</label>
                <select id="con" name="con" required>
                    <option value="">-- Select Status --</option>
                    <option value="">All</option>
                    <option value="yes">Connected (Yes)</option>
                    <option value="no">Not Connected (No)</option>
                </select>
            </div>
