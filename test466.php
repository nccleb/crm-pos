...
<head>
    ...
    <title>Agent Statistics - Search</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <form method="post" action="test465.php" id="searchForm">
            ...
            <div class="form-group">
                ...
                <input type="text" id="age" name="age" placeholder="Enter agent name or ID" required>
            </div>
